...
namespace CodefirstApp.Controllers
{
    public class SuppliersController : Controller
    {
        ...
        public SuppliersController(App context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var suppliers = await _context.Supplier.FindAsync(id);
            if (suppliers == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Address,Contact,Email")] Suppliers suppliers)
        {
            if (id != suppliers.Id)
            {
                return NotFound();
